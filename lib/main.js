...
function tryMergeAsync(octokit, baseBranch, headBranch) {
    return __awaiter(this, void 0, void 0, function* () {
        const context = github.context;
        try {
            yield octokit.repos.merge(Object.assign({ base: baseBranch, head: headBranch }, context.repo));
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const result = yield tryMergeAsync(octokit, baseBranch, headBranch);
            if (!!result) {
                return;
            }
