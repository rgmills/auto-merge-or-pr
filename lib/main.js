...
function tryMergeAsync(octokit, baseBranch, headBranch, commit_message, allowDelay = false) {
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const result = yield tryMergeAsync(octokit, baseBranch, headBranch, commitMessage, !!waitForChecks);
            if (!!result) {
                return;
            }
            ...
            if (!!branchExists) {
                try {
                    ...
                    const mergeResult = yield tryMergeAsync(octokit, headConflictsBranch, headBranch, `Automatic merge from '${headBranch}'`, !!waitForChecks);
                    if (!mergeResult) {
                        try {
